...
var createLegoBlock = function (command, legos, language) {
    if (legos === void 0) { legos = []; }
    if (language === void 0) { language = 'Node JS'; }
    return __awaiter(void 0, void 0, void 0, function () {
        var engine, prompt, maxTokens, temperature, topP, presencePenalty, frequencyPenalty, bestOf, n, stream, stop, response;
