...
*/
const createLegoBlock = async (name: string, command: string, legos: string[] = [], language: string = 'NodeJS'): Promise<any> => {
    try {
        ...
        /*
        Creating a string module that exports three variables: lego, command, and language.
        - generated by stenography 🤖
        */
        const legoStr = `{"command": "${command}",\n"lego": ${JSON.stringify(response.data.choices[0].text.trim())}, "language":"${language}"}`
    
        /*
        This code is writing legoStr to a file {command}.ts
        - generated by stenography 🤖
        */
        await fs.writeFile(`legos/${name}.json`, legoStr);        
    } catch (err) {
